...
import console.ColoredConsole.Companion.BLACK
import console.ColoredConsole.Companion.BRIGHT_BLACK
import console.ColoredConsole.Companion.BRIGHT_WHITE
import console.ColoredConsole.Companion.RESET
import console.ColoredConsole.Companion.WHITE
import console.ColoredConsole.Style
import console.ColoredConsole.Style.NotApplied
...
interface ColoredConsole {
    ...
    private val String.firstAnsi get() = reEscape.find(this)?.let { matcher ->
        if( matcher.range.first != 0) null else matcher.groups[1]?.value?.toIntOrNull()
    }
